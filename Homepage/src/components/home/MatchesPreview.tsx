...
const activity = [
  { type: "Cricket", title: "LordOfCricket League", detail: "Structured demo fixture · API-ready data", date: "18 SEP", time: "07:30 PM", number: "01" },
  { type: "Karate", title: "Precision Open", detail: "Structured demo fixture · API-ready data", date: "21 SEP", time: "06:00 PM", number: "02" },
  { type: "Lawn Tennis", title: "The Rally Series", detail: "Structured demo fixture · API-ready data", date: "28 SEP", time: "04:30 PM", number: "03" },
];

export default function MatchesPreview() {
  return (
    <section id="matches" aria-labelledby="matches-heading" className="border-t border-line-soft py-24 sm:py-32">
      <Container>
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
          <Reveal>
            <span className="text-xs font-semibold tracking-[0.3em] text-accent uppercase">03 / Live platform</span>
            <h2 id="matches-heading" className="mt-4 max-w-md font-display text-5xl leading-[0.9] text-paper sm:text-6xl">
              WHAT&apos;S ON.
            </h2>
            <p className="mt-6 max-w-sm text-base leading-relaxed text-muted">
              Matches, leagues and tournaments are coming together in one place. Follow the action as the universe gets moving.
            </p>
            <Button href="#sports" variant="ghost" className="mt-6 px-0">EXPLORE THE UNIVERSE</Button>
          </Reveal>
